...
var oneToTwenty = require('../lib.js').oneToTwenty;
var twoToForty = require('../lib.js').twoToForty;
var tenToOneThousand = require('../lib.js').tenToOneThousand;
var search = require('../lib.js').search;
